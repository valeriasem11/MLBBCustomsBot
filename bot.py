...
CHALLENGES_POOL = [
    "Сыграй матч, используя танка.",
    "Сыграй матч, используя поддержку.",
    "Сыграй матч, используя лесника.",
    "Сыграй матч, используя стрелка.",
    "Сыграй матч, используя мага.",
    "Сыграй матч, используя бойца.",
    "Сыграй матч, используя убийцу.",
    "Сделай 10 убийств за один матч.", 
    "Сделай 15 ассистов за один матч.", 
    "Получи MVP.",
    "Победи, играя героем, которого определит бот случайным образом.",
    "Выиграй 3 матча подряд.",
    "Выиграй матч, умерев не более 2 раз.",
    ...
    "Не использовать спелл (Вспышка/Очищение и т.д.) весь матч.",
    "Весь матч фармить лес, даже если ты не Лесник.",
    ...
    "Первые 5 минут не покидать свою линию для ганга.",
    "Не покупать ботинки до 10-й минуты.",
    "Отдать выбор героя случайному решению союзника.",
    "Сделай первую кровь.",
    "Первую покупку выбрать не глядя, наугад.",
    "Всю игру общаться в чате только капслоком.",
    "Выиграй матч менее чем за 15 минут.",
    "Не смотреть на мини-карту первые 3 минуты матча.",
    "Взять героя другой линии",
    "Один раз специально стоять на месте под вражеской башней 3 секунды.",
    "Похвалить каждого союзника в чате хотя бы один раз за матч.",
]

ROASTS_POOL = [
    "Ты фармишь так усердно, будто крипы платят тебе зарплату.",
    "Ты исчезаешь с карты чаще, чем появляешься на ней.",
    "Похоже, фонтан уже начал брать с тебя арендную плату.",
    "Если бы за фарм выдавали дипломы, ты был бы профессором.",
    "Пока ты добежал до Лорда, он успел родиться, вырасти и выйти на пенсию.",
    "Для тебя миникарта — это просто красивое украшение интерфейса.",
    "Ты убегаешь так быстро, что союзники не успевают даже попрощаться.",
    "Ты настолько крепкий танк, что забыл, кого вообще нужно защищать.",
    "Без фарма ты больше похож на очень уверенного в себе миньона.",
    "Кажется, лес уже официально признал тебя своим постоянным жителем.",
    "Пока ты кастуешь заклинание, бой уже успевает закончиться.",
    "Ты настолько скрытный ассасин, что тебя не видели даже союзники.",
    "Ты посетил все линии... кроме той, где действительно была нужна помощь.",
    "Инвентарь у тебя уже полный, осталось только наполнить его хорошими решениями.",
    "Главное — не победа, а красивый счёт. Желательно не 0/8/1.",
    "Ты так усердно зачищаешь лес, что крипы скоро начнут платить тебе аренду.",
    "Твоя реакция на ганг настолько быстрая, что обычно приходит уже после твоей смерти.",
    "Ты играешь на танке так осторожно, будто броню выдали в кредит.",
    "Такое ощущение, что ты выбираешь роль не по предпочтениям, а по принципу «что осталось».",
    "Когда ты берёшь Лейлу на EXP, вражеский ассасин начинает улыбаться ещё на загрузочном экране.",
    "Твой ультимейт был настолько точным, что не попал вообще никому.",
    "Со счётом 0/8/1 ты уже можешь оформить постоянную прописку на фонтане.",
    "Ты нажал Вспышку в стену? Зато проверил, что коллизия в игре работает идеально.",
    "На твоём месте даже Гусь начал бы сомневаться в своих полётах.",
    "Ты так уверенно забрал Лорда... что он решил играть за противников.",
    "Ты настолько любишь стоять под башней, что скоро начнёшь платить ей арендную плату.",
    "Твоя сборка выглядит так, будто ты покупал предметы с закрытыми глазами.",
    "Смотреть на твою Фанни — это как смотреть фильм ужасов: страшно, смешно и очень хочется, чтобы это скорее закончилось.",
    "Ты заходишь в драку так уверенно, будто уже договорился с фонтаном о встрече.",
    "Ты так часто возвращаешься на базу, что продавец в магазине уже знает тебя по имени."
]

COMPLIMENTS_POOL = [
    "Похоже, сегодня победа решила играть именно на твоей стороне.",
    "Ты так уверенно играешь, что противники уже мысленно нажали кнопку «Сдаться».",
    "Похоже, сегодня миникарта работает только для тебя.",
    "Ты фармишь настолько быстро, что крипы уже сами бегут тебе навстречу.",
    "Пока враги искали тебя, ты уже успел выиграть файт.",
    "Ты настолько вовремя пришёл на помощь, что союзники ещё долго будут это вспоминать.",
    "Кажется, Лорд сегодня был твоим личным питомцем.",
    "Ты настолько хорошо читаешь карту, будто сам её рисовал.",
    "Ты играешь так уверенно, будто заранее знаешь, что сделает соперник.",
    "Сегодня твои ганги работают лучше любого будильника.",
    "Кажется, враги уже начали обходить тебя стороной.",
    "Ты настолько хорош в файтах, что даже фонтан по тебе соскучился.",
    "Твой ультимейт попал именно туда, куда должен был.",
    "Сегодня ты не искал победу — победа сама нашла тебя.",
    "Ты так быстро принимаешь решения, что враги не успевают их понять.",
    "Кажется, твой герой сегодня получил скрытый бафф.",
    "Ты настолько уверенно контролируешь линию, что миньоны уже считают тебя своим лидером.",
    "Сегодня ты выглядишь как человек, который точно знает, что делает.",
    "Твои тайминги сегодня заслуживают отдельных аплодисментов.",
    "Кажется, именно ради таких моментов и запускают Mobile Legends.",
    "Ты сегодня раздаёшь урон с такой щедростью, что врагам впору благодарить тебя за внимание.",
    "Похоже, противники уже мечтают закончить этот матч.",
    "Твой KDA сегодня выглядит так, будто ты забыл, что можно проигрывать.",
    "Ты настолько уверенно забрал Лорда, что он даже не сопротивлялся.",
    "Сегодня кусты работают исключительно в твою пользу.",
    "Кажется, твоя сборка сегодня собрана не из предметов, а из здравого смысла.",
    "Даже ассасины сегодня не рискнули подходить к тебе слишком близко.",
    "Сегодня ты выглядишь как MVP ещё до конца матча.",
    "Продолжай в том же духе — враги уже начинают нервничать.",
    "Похоже, сегодня именно ты задаёшь темп всей игре."
]
